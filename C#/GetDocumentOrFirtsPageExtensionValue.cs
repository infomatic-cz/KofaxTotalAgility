    ...
    public Class1() 
    {
        ...
        public void RunSetPageExtension(ScriptParameters sp)
        {
            ...
            try
            {
                ...
                string documentId = sp.InputVariables["DOCUMENT_F938266C4CC640FC8C289D1FE732CD3E"].ToString();
                ...
                extensions = GetExtensions(sessionId, document, extensionName, extensions);
                ...
                {
                    sp.OutputVariables["DocumentEmailArchiveId"] = Convert.ToInt32(extensions[0]);
                }
                else if (extensions.Count > 1)
                {
        ...
        public List<string> GetExtensions(string sessionId, Agility.Sdk.Model.Capture.Document document, string extensionName, List<string> extensions)
        {
            CaptureDocumentService captureDocumentService = new CaptureDocumentService();
