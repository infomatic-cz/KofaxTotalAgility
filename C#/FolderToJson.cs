    ...
    public Class1() 
    {
        ...
        public void RunSetPageExtension(ScriptParameters sp)
        {
            ...
            try
            {
                ...
                // Add .Net assembly with Load assembly using full path
                // C:\Program Files\Kofax\TotalAgility\Agility.Server.Web\bin\Newtonsoft\Newtonsoft.Json.dll
                // Add it to BR references together with TotalAgility.Sdk.dll and System.Data.dll
                string json = JsonConvert.SerializeObject(folder, Newtonsoft.Json.Formatting.Indented);

                sp.OutputVariables["FolderJson"] = json;
