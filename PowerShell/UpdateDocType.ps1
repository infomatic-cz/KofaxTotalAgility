...
$Url = "https://localhost/TotalAgility/services/sdk/capturedocumentservice.svc/json/UpdateDocumentType2"    
...
$Body = @{
    ...
    documentId = "bcd3eaec-bc58-4330-8a08-aeec00b5b6b8"
    documentTypeIdentity = @{ Id = "BA4C7561117948EB91D1C1A50608D6FA" }
}
